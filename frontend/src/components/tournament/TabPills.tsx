...
export default function TabPills() {
  ...
  return (
    <div className="border-b bg-background/35 backdrop-blur-sm" style={{ borderColor: 'var(--color-data-divider)' }}>
            ...
            >
              ...
              {isActive && (
                <motion.div
                  ...
                  className="absolute bottom-0 left-3 right-3 h-0.5 rounded-full bg-gradient-to-r from-primary via-gold-orange to-accent"
                  style={{ boxShadow: '0 0 14px rgba(255,138,0,0.55)' }}
