...
export default function TeamDetailPage() {
  ...
  return (
    <motion.div className="relative max-w-7xl mx-auto px-6 py-8 space-y-10" variants={pageReveal} initial="hidden" animate="show">
      ...
      {team.players && team.players.length > 0 && (
        <section>
          ...
          <motion.div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3" variants={staggerContainer} initial="hidden" animate="show">
            {team.players.map(p => (
              <motion.div
                key={p.id}
                variants={fadeUp}
